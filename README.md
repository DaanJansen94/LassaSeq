...
2. **Visualizing Trees**:
   ...
   - Use the metadata columns to color and annotate your tree:
     - Location (country)
     - Location2 (specific location)
     - Host
     - Date

The metadata files are pre-formatted for FigTree, allowing easy visualization of geographical, temporal, and host-specific patterns in your phylogenetic trees.
