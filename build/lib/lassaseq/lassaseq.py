...
def filter_by_lineage(sequences, target_lineage=None, target_sublineage=None):
    """Filter sequences based on lineage and/or sublineage"""
    if not target_lineage and not target_sublineage:
        return sequences
...
Example: --lineage "LineageIV"''')
        
        parser.add_argument('--sublineage', type=str,
                          help='''(Optional) Filter sequences by sublineage
Example: --sublineage "SublineageIII"
Note: If --lineage is not specified, will match the sublineage across all lineages''')
        ...
        if args.lineage or args.sublineage:
            ...
            if args.sublineage:
                print(f"Sublineage: {args.sublineage}")
